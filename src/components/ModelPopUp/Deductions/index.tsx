...
const Deduction: React.FC<{ isOpen: boolean; onClose: () => void }> = ({
  isOpen,
  onClose,
}) => {
      ...
      >
        ...
        <ModalContent>
          ...
          >
            {(props) => (
              <Form>
                <ModalHeader>Deductions</ModalHeader>
                <Divider
                  mt="0.1rem"
                  mb="1.2rem"
                  border="0"
                    ...
                    {({ field }: any) => (
                      <Box width="100%" mb="5">
                        ...
                        <Select>
                          ...
                          <option value="Taxsaver FD">Taxsaver FD</option>
                          <option value="MF Taxsave">MF Taxsave</option>
                          <option value="Tution Fee">Tution Fee</option>
                          <option value="House Loan Interest Certificate">
                            House Loan Interest Certificate
                          </option>
                          <option value="PPF">PPF</option>
                          <option value="Sukanyasamridhi">
                            Sukanyasamridhi
                          </option>
