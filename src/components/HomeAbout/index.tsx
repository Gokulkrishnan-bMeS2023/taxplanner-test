  ...
  <Box py={5}>
    ...
    >
      ...
      <Box flex={{ base: "100%", lg: "6" }} mb="4">
        <Animation>
          ...
          <Text fontWeight="bolder" lineHeight={1.5}>
            Sign Up For Free
          </Text>
          <Text lineHeight={1.5} mb="1.5rem">
          ...
          <Text lineHeight={1.5} mb="1.5rem">
            We have a vast number of services to help you file your tax returns
            and run your business smoother.
          </Text>
          <Text fontWeight="bolder" lineHeight={1.5}>
            Have a Doubt?, Contact
          </Text>
          <Text lineHeight={1.5} mb="1.5rem">
            Our expert will reach you and clarify your queries, for you to
            choose the best plan.
          </Text>
          <Text fontWeight="bolder" lineHeight={1.5}>
            All Clear, Add to Cart
          </Text>
          <Text lineHeight={1.5}>
            You only have to pay for the service you choose. No membership fee
            needed.
          </Text>
        </Animation>
      </Box>
    ...
    <Animation>
      <Flex flexWrap="wrap" border="1px solid #DFE4FD" borderRadius={8} p={5}>
        ...
        >
          <Feature
            icon={<FaPhone size={18} style={{ transform: "rotate(90deg)" }} />}
