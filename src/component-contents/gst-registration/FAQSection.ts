export const FAQs = [
  ...
  {
    id: 2,
    title: "Does GST apply to my business?",
    active: "tab-pane-2",
    paragraph: [
  ...
  {
    id: 3,
    title: "Do I need PAN to apply for GST registration?",
    active: "tab-pane-3",
    paragraph: [
  ...
  {
    id: 4,
    title: "Earlier I had opted for composition scheme under VAT. Is the concept of composition scheme still there under GST?",
    active: "tab-pane-4",
    paragraph: [
  ...
  {
    id: 5,
    title: "Who is a non-resident taxable person under GST?",
    active: "tab-pane-5",
    paragraph: [
  ...
  {
    id: 6,
    title: "Is there any time Limit for GST Registration?",
    active: "tab-pane-6",
    paragraph: [
