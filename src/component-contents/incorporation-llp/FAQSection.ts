export const FAQs = [
  ...
  {
    id: 4,
    title: "What is the minimum capital requirement for LLPs?",
    paragraph: ["There is no minimum capital contribution requirement."],
    Fs: [
  ...
  {
    id: 5,
    title: "What is the audit requirement for LLP?",
    paragraph: [
