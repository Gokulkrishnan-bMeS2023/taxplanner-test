export const FAQs = [
  ...
  {
    id: 2,
    title: "Why is filing GSTR 3B important?",
    active: "tab-pane-2",
    img: "",
    paragraph: [
  ...
  },
  {
    ...
    Fs1: ["Credit notes", "Input Service Distributors"],
    FsHeading:
      "However, the following registrants do not have to file GSTR 3B.",
  },
  {
    id: 5,
    title: "What is GSTR 3B? Who needs to file GSTR 3B?",
    active: "tab-pane-5",
    img: "",
    paragraph: [
  ...
  {
    id: 6,
    title: "What are the details to be submitted in GSTR-3B?",
    active: "tab-pane-6",
    img: "",
    paragraph: [
