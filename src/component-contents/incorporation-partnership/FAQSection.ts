export const FAQs = [
  ...
  {
    id: 2,
    title: "Why should Partnership Firm go for registration?",
    paragraph: [
  ...
  {
    id: 3,
    title: "When should we apply for registration of our partnership firm ?",
    paragraph: [
  ...
  {
    id: 4,
    title: "Is there any guideline on choosing name for the firm?",
    paragraph: [
  ...
  {
    id: 5,
    title: "What will be the government fee for firm registration?",
    paragraph: [
