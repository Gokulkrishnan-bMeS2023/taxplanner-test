export const FAQs = [
  {
    id: 1,
    title: "What is SPICe- process of company incorporation?",
    paragraph: [
  ...
  },
  {
    id: 2,
    title:
      "How can I become eligible to get benefits under the Stratup India Initiative?",
    paragraph: [
      "Only the below stated entities qualify as a “Startup” for the purpose of Government schemes.",
    ],
    Fs1: ["Limited Liability Partnership"],
    FsHeading: "Further conditions are:",
    Fs: [
  ...
  {
    id: 6,
    title: "Is stamp duty payable during incorporation process?",
    paragraph: [
  ...
  {
    id: 7,
    title: "How much time is needed to set up a private limited company?",
    paragraph: [
