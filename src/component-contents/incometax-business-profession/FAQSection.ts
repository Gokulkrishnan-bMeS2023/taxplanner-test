export const FAQs = [
  {
    id: 1,
    title: "Who can opt for the presumptive taxation scheme?",
    paragraph: [
  ...
  {
    id: 2,
    title: "What are the benefits under Presumptive Taxation Scheme?",
    paragraph: [
  ...
  {
    id: 3,
    title: "I am a shopkeeper and wish to declare income less than 8% of my gross turnover. How can i do that?",
    paragraph: [
  ...
  {
    id: 4,
    title: "I am an insurance agent and my gross receipts are Rs. 40 lakh. Am i eligible under presumptive taxation scheme?",
    paragraph: [
  ...
  {
    id: 6,
    title: "Am I required to keep a copy of the return filed as proof and for how long?",
    paragraph: [
