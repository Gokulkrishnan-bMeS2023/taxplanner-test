export const FAQs = [
  ...
  },
  {
    ...
    Fs: [
      "The validity of the DSC can be renewed once the term of the previous DSC expires.",
      "Under the present plan you get DSC with validity of 2 years.",
    ],
  },
  {
    id: 3,
    ...
    Fs: [
      "It is mandatory to inform the govt. authorities about the expiry of the old DSC and issue of a new one.",
    ],
  },
  {
    id: 4,
