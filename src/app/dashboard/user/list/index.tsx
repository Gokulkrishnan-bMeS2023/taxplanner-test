...
export default function UserList({ staffDatas }: StaffProps) {
  const [staffData, setData] = useState(staffDatas);
        ...
        >
          ...
          <Thead display={{ base: "none", md: "table-header-group" }}>
            ...
            >
              ...
              >
                Full Name
                <SortIconGroup sortConfig={sortConfig} KeyType="firstName" />
              </Th>
                ...
                {currentEntries.map((staff, index) => (
                  <Tr key={index + 1}>
                    <Td color="#01acf1" border={"1px solid #e3e6f0"}>
                      ...
                      >
                        <Link href={`/dashboard/user/edit?id=${staff.id}`}>
                          {staff.email}
                        </Link>
                      </Text>
                    </Td>
