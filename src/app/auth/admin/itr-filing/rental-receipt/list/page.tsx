          ...
          {filteredUser.length === 0 ? (
            ...
            <>
                      ...
                      <>
                        <Tr>
                          <Td border={"1px solid #e3e6f0"}>
                            <Text as={"b"}>Water Mark :</Text> yes / no
                          </Td>
                        </Tr>
                        <Tr>
                          <Td border={"1px solid #e3e6f0"}>
                            <Text as={"b"}>TransDate:</Text> 10/09/2022
                          </Td>
                        </Tr>
                      </>
                    )}
              ...
              <Tbody display={{ base: "none", md: "table-row-group" }}>
                {currentEntries.map((user, index) => (
                  <Tr key={index + 1}>
                    <Td border={"1px solid #e3e6f0"} color="#01acf1">
                      <Text
                        width={"fit-content"}
                    ...
                    <Td border={"1px solid #e3e6f0"}>yes</Td>
                    <Td border={"1px solid #e3e6f0"}> Transaction Date Data</Td>
                  </Tr>
                ))}
              </Tbody>
            </>
...
export default CaptialGainList;
